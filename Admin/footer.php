...
<footer>
          <img  id="end" src="../img/logo (3).png" alt="kfu"/>
                 ...
                 <table class="foot1">
                     ...
                     <tr>  <td > <a href="#"><img class="n" src="../location.png" alt=""/></a> King Faisal University 1st,Al Hofuf  </td> </tr>
                     <tr>  <td><img class="n" src="../call.png" alt=""/>+966553378483</td></tr>
                     <tr> <td> <a href="#"><img class="n" src="../email.png" alt=""/></a> KFUGYM@gmail.com</td></tr>
                 </table>
            <div id="con">
                <br><br><br>
